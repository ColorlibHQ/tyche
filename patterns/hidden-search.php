<?php
/**
 * Title: Search template body
 * Slug: tyche/hidden-search
 * Viewport Width: 1400
 * Inserter: no
 *
 * @package Tyche
...
<div class="wp-block-group alignwide tyche-page-head"><!-- wp:query-title {"type":"search","className":"tyche-page-title"} /-->

<!-- wp:search {"label":"<?php echo esc_attr__( 'Search', 'tyche' ); ?>","showLabel":false,"buttonText":"<?php echo esc_attr__( 'Search', 'tyche' ); ?>","className":"tyche-search-page__form"} /--></div>
<!-- /wp:group -->
