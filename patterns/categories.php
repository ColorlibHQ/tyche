...
<div class="wp-block-column"><!-- wp:cover {"url":"<?php echo esc_url( get_theme_file_uri( 'assets/images/cat-coats.jpg' ) ); ?>","dimRatio":20,"overlayColor":"dark","isUserOverlayColor":true,"contentPosition":"bottom left","className":"tyche-tile is-style-tyche-zoom","style":{"dimensions":{"aspectRatio":"4/5"}},"layout":{"type":"constrained"}} -->
<div class="wp-block-cover has-custom-content-position is-position-bottom-left tyche-tile is-style-tyche-zoom"><img class="wp-block-cover__image-background" alt="" src="<?php echo esc_url( get_theme_file_uri( 'assets/images/cat-coats.jpg' ) ); ?>" data-object-fit="cover"/><span aria-hidden="true" class="wp-block-cover__background has-dark-background-color has-background-dim-20 has-background-dim"></span><div class="wp-block-cover__inner-container"><!-- wp:heading {"level":3,"className":"tyche-tile__title","textColor":"overlay","fontSize":"xx-large"} -->
...
<!-- wp:column -->
<div class="wp-block-column"><!-- wp:cover {"url":"<?php echo esc_url( get_theme_file_uri( 'assets/images/cat-knitwear.jpg' ) ); ?>","dimRatio":20,"overlayColor":"dark","isUserOverlayColor":true,"contentPosition":"bottom left","className":"tyche-tile is-style-tyche-zoom","style":{"dimensions":{"aspectRatio":"4/5"}},"layout":{"type":"constrained"}} -->
<div class="wp-block-cover has-custom-content-position is-position-bottom-left tyche-tile is-style-tyche-zoom"><img class="wp-block-cover__image-background" alt="" src="<?php echo esc_url( get_theme_file_uri( 'assets/images/cat-knitwear.jpg' ) ); ?>" data-object-fit="cover"/><span aria-hidden="true" class="wp-block-cover__background has-dark-background-color has-background-dim-20 has-background-dim"></span><div class="wp-block-cover__inner-container"><!-- wp:heading {"level":3,"className":"tyche-tile__title","textColor":"overlay","fontSize":"xx-large"} -->
...
<!-- wp:column -->
<div class="wp-block-column"><!-- wp:cover {"url":"<?php echo esc_url( get_theme_file_uri( 'assets/images/cat-dresses.jpg' ) ); ?>","dimRatio":20,"overlayColor":"dark","isUserOverlayColor":true,"contentPosition":"bottom left","className":"tyche-tile is-style-tyche-zoom","style":{"dimensions":{"aspectRatio":"4/5"}},"layout":{"type":"constrained"}} -->
<div class="wp-block-cover has-custom-content-position is-position-bottom-left tyche-tile is-style-tyche-zoom"><img class="wp-block-cover__image-background" alt="" src="<?php echo esc_url( get_theme_file_uri( 'assets/images/cat-dresses.jpg' ) ); ?>" data-object-fit="cover"/><span aria-hidden="true" class="wp-block-cover__background has-dark-background-color has-background-dim-20 has-background-dim"></span><div class="wp-block-cover__inner-container"><!-- wp:heading {"level":3,"className":"tyche-tile__title","textColor":"overlay","fontSize":"xx-large"} -->
...
<!-- wp:column -->
<div class="wp-block-column"><!-- wp:cover {"url":"<?php echo esc_url( get_theme_file_uri( 'assets/images/cat-accessories.jpg' ) ); ?>","dimRatio":20,"overlayColor":"dark","isUserOverlayColor":true,"contentPosition":"bottom left","className":"tyche-tile is-style-tyche-zoom","style":{"dimensions":{"aspectRatio":"4/5"}},"layout":{"type":"constrained"}} -->
<div class="wp-block-cover has-custom-content-position is-position-bottom-left tyche-tile is-style-tyche-zoom"><img class="wp-block-cover__image-background" alt="" src="<?php echo esc_url( get_theme_file_uri( 'assets/images/cat-accessories.jpg' ) ); ?>" data-object-fit="cover"/><span aria-hidden="true" class="wp-block-cover__background has-dark-background-color has-background-dim-20 has-background-dim"></span><div class="wp-block-cover__inner-container"><!-- wp:heading {"level":3,"className":"tyche-tile__title","textColor":"overlay","fontSize":"xx-large"} -->
