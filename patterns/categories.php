...
<section class="wp-block-group alignfull tyche-section tyche-categories" style="padding-top:var(--wp--preset--spacing--70);padding-bottom:var(--wp--preset--spacing--70)">
...
<div class="wp-block-columns alignwide tyche-tiles">
<!-- wp:column -->
<div class="wp-block-column">
<!-- wp:cover {"url":"<?php echo esc_url( get_theme_file_uri( 'assets/images/cat-coats.jpg' ) ); ?>","dimRatio":100,"customGradient":"linear-gradient(180deg,rgba(12,10,8,0) 30%,rgba(12,10,8,0.72) 100%)","isUserOverlayColor":true,"contentPosition":"bottom left","className":"tyche-tile is-style-tyche-zoom","style":{"dimensions":{"aspectRatio":"4/5"}},"layout":{"type":"constrained"}} -->
...
<!-- wp:heading {"level":3,"className":"tyche-tile__title","textColor":"overlay","fontSize":"xx-large"} -->
...
<!-- wp:column -->
<div class="wp-block-column">
<!-- wp:cover {"url":"<?php echo esc_url( get_theme_file_uri( 'assets/images/cat-knitwear.jpg' ) ); ?>","dimRatio":100,"customGradient":"linear-gradient(180deg,rgba(12,10,8,0) 30%,rgba(12,10,8,0.72) 100%)","isUserOverlayColor":true,"contentPosition":"bottom left","className":"tyche-tile is-style-tyche-zoom","style":{"dimensions":{"aspectRatio":"4/5"}},"layout":{"type":"constrained"}} -->
...
<!-- wp:column -->
<div class="wp-block-column">
<!-- wp:cover {"url":"<?php echo esc_url( get_theme_file_uri( 'assets/images/cat-dresses.jpg' ) ); ?>","dimRatio":100,"customGradient":"linear-gradient(180deg,rgba(12,10,8,0) 30%,rgba(12,10,8,0.72) 100%)","isUserOverlayColor":true,"contentPosition":"bottom left","className":"tyche-tile is-style-tyche-zoom","style":{"dimensions":{"aspectRatio":"4/5"}},"layout":{"type":"constrained"}} -->
...
<!-- wp:column -->
<div class="wp-block-column">
<!-- wp:cover {"url":"<?php echo esc_url( get_theme_file_uri( 'assets/images/cat-accessories.jpg' ) ); ?>","dimRatio":100,"customGradient":"linear-gradient(180deg,rgba(12,10,8,0) 30%,rgba(12,10,8,0.72) 100%)","isUserOverlayColor":true,"contentPosition":"bottom left","className":"tyche-tile is-style-tyche-zoom","style":{"dimensions":{"aspectRatio":"4/5"}},"layout":{"type":"constrained"}} -->
