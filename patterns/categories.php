...
<!-- wp:column -->
<div class="wp-block-column"><!-- wp:cover {"url":"<?php echo esc_url( get_theme_file_uri( 'assets/images/cat-knitwear.jpg' ) ); ?>","isUserOverlayColor":true,"customGradient":"linear-gradient(180deg,rgba(12,10,8,0) 30%,rgba(12,10,8,0.72) 100%)","contentPosition":"bottom left","className":"tyche-tile is-style-tyche-zoom","style":{"dimensions":{"aspectRatio":"4/5"}},"layout":{"type":"constrained"}} -->
...
<!-- wp:column -->
<div class="wp-block-column"><!-- wp:cover {"url":"<?php echo esc_url( get_theme_file_uri( 'assets/images/cat-dresses.jpg' ) ); ?>","isUserOverlayColor":true,"customGradient":"linear-gradient(180deg,rgba(12,10,8,0) 30%,rgba(12,10,8,0.72) 100%)","contentPosition":"bottom left","className":"tyche-tile is-style-tyche-zoom","style":{"dimensions":{"aspectRatio":"4/5"}},"layout":{"type":"constrained"}} -->
...
<!-- wp:column -->
<div class="wp-block-column"><!-- wp:cover {"url":"<?php echo esc_url( get_theme_file_uri( 'assets/images/cat-accessories.jpg' ) ); ?>","isUserOverlayColor":true,"customGradient":"linear-gradient(180deg,rgba(12,10,8,0) 30%,rgba(12,10,8,0.72) 100%)","contentPosition":"bottom left","className":"tyche-tile is-style-tyche-zoom","style":{"dimensions":{"aspectRatio":"4/5"}},"layout":{"type":"constrained"}} -->
