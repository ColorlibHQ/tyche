...
<h3 class="wp-block-heading tyche-tile__title has-overlay-color has-text-color has-xx-large-font-size"><a href="<?php echo esc_url( tyche_category_url( 'coats' ) ); ?>"><?php esc_html_e( 'Coats', 'tyche' ); ?></a></h3>
<!-- /wp:heading -->
...
<h3 class="wp-block-heading tyche-tile__title has-overlay-color has-text-color has-xx-large-font-size"><a href="<?php echo esc_url( tyche_category_url( 'knitwear' ) ); ?>"><?php esc_html_e( 'Knitwear', 'tyche' ); ?></a></h3>
<!-- /wp:heading -->
...
<h3 class="wp-block-heading tyche-tile__title has-overlay-color has-text-color has-xx-large-font-size"><a href="<?php echo esc_url( tyche_category_url( 'dresses' ) ); ?>"><?php esc_html_e( 'Dresses', 'tyche' ); ?></a></h3>
<!-- /wp:heading -->
...
<h3 class="wp-block-heading tyche-tile__title has-overlay-color has-text-color has-xx-large-font-size"><a href="<?php echo esc_url( tyche_category_url( 'accessories' ) ); ?>"><?php esc_html_e( 'Accessories', 'tyche' ); ?></a></h3>
<!-- /wp:heading -->
