...
<main class="wp-block-group tyche-main tyche-order-confirmation" style="padding-top:var(--wp--preset--spacing--60);padding-bottom:var(--wp--preset--spacing--80);margin-top:0">
<!-- wp:woocommerce/order-confirmation-status {"fontSize":"x-large","className":"tyche-order-status"} /-->
