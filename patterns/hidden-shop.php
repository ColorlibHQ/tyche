<?php
/**
 * Title: Shop template body
 * Slug: tyche/hidden-shop
 * Viewport Width: 1400
 * Inserter: no
 *
 * @package Tyche
...
<main class="wp-block-group tyche-main" style="padding-top:var(--wp--preset--spacing--40);padding-bottom:var(--wp--preset--spacing--80);margin-top:0">
...
<!-- wp:query-title {"type":"archive","showPrefix":false,"level":1,"className":"tyche-page-title"} /-->
<!-- wp:term-description {"className":"tyche-term-description"} /-->
</div>
<!-- /wp:group -->

<!-- wp:columns {"align":"wide","className":"tyche-shop","style":{"spacing":{"blockGap":{"top":"var:preset|spacing|60","left":"var:preset|spacing|60"}}}} -->
<div class="wp-block-columns alignwide tyche-shop">
<!-- wp:column {"width":"264px","className":"tyche-shop__filters"} -->
<div class="wp-block-column tyche-shop__filters" style="flex-basis:264px">
