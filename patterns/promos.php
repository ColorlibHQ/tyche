...
<div class="wp-block-column"><!-- wp:cover {"url":"<?php echo esc_url( get_theme_file_uri( 'assets/images/promo-1.jpg' ) ); ?>","dimRatio":40,"overlayColor":"dark","isUserOverlayColor":true,"minHeight":560,"minHeightUnit":"px","contentPosition":"bottom left","className":"tyche-promo is-style-tyche-zoom","layout":{"type":"constrained"}} -->
<div class="wp-block-cover has-custom-content-position is-position-bottom-left tyche-promo is-style-tyche-zoom" style="min-height:560px"><img class="wp-block-cover__image-background" alt="" src="<?php echo esc_url( get_theme_file_uri( 'assets/images/promo-1.jpg' ) ); ?>" data-object-fit="cover"/><span aria-hidden="true" class="wp-block-cover__background has-dark-background-color has-background-dim-40 has-background-dim"></span><div class="wp-block-cover__inner-container"><!-- wp:paragraph {"className":"is-style-tyche-eyebrow","textColor":"overlay"} -->
...
<!-- wp:column -->
<div class="wp-block-column"><!-- wp:cover {"url":"<?php echo esc_url( get_theme_file_uri( 'assets/images/promo-2.jpg' ) ); ?>","dimRatio":40,"overlayColor":"dark","isUserOverlayColor":true,"minHeight":560,"minHeightUnit":"px","contentPosition":"bottom left","className":"tyche-promo is-style-tyche-zoom","layout":{"type":"constrained"}} -->
