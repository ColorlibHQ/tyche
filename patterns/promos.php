...
<div class="wp-block-column"><!-- wp:cover {"url":"<?php echo esc_url( get_theme_file_uri( 'assets/images/promo-1.webp' ) ); ?>","isUserOverlayColor":true,"minHeight":560,"minHeightUnit":"px","customGradient":"linear-gradient(180deg,rgba(12,10,8,0.15) 0%,rgba(12,10,8,0.6) 38%,rgba(12,10,8,0.85) 100%)","contentPosition":"bottom left","className":"tyche-promo is-style-tyche-zoom","layout":{"type":"constrained"}} -->
<div class="wp-block-cover has-custom-content-position is-position-bottom-left tyche-promo is-style-tyche-zoom" style="min-height:560px"><img class="wp-block-cover__image-background" alt="" src="<?php echo esc_url( get_theme_file_uri( 'assets/images/promo-1.webp' ) ); ?>" data-object-fit="cover"/><span aria-hidden="true" class="wp-block-cover__background has-background-dim-100 has-background-dim wp-block-cover__gradient-background has-background-gradient" style="background:linear-gradient(180deg,rgba(12,10,8,0.15) 0%,rgba(12,10,8,0.6) 38%,rgba(12,10,8,0.85) 100%)"></span><div class="wp-block-cover__inner-container"><!-- wp:paragraph {"className":"is-style-tyche-eyebrow","textColor":"overlay"} -->
...
<!-- wp:column -->
<div class="wp-block-column"><!-- wp:cover {"url":"<?php echo esc_url( get_theme_file_uri( 'assets/images/promo-2.webp' ) ); ?>","isUserOverlayColor":true,"minHeight":560,"minHeightUnit":"px","customGradient":"linear-gradient(180deg,rgba(12,10,8,0.15) 0%,rgba(12,10,8,0.6) 38%,rgba(12,10,8,0.85) 100%)","contentPosition":"bottom left","className":"tyche-promo is-style-tyche-zoom","layout":{"type":"constrained"}} -->
<div class="wp-block-cover has-custom-content-position is-position-bottom-left tyche-promo is-style-tyche-zoom" style="min-height:560px"><img class="wp-block-cover__image-background" alt="" src="<?php echo esc_url( get_theme_file_uri( 'assets/images/promo-2.webp' ) ); ?>" data-object-fit="cover"/><span aria-hidden="true" class="wp-block-cover__background has-background-dim-100 has-background-dim wp-block-cover__gradient-background has-background-gradient" style="background:linear-gradient(180deg,rgba(12,10,8,0.15) 0%,rgba(12,10,8,0.6) 38%,rgba(12,10,8,0.85) 100%)"></span><div class="wp-block-cover__inner-container"><!-- wp:paragraph {"className":"is-style-tyche-eyebrow","textColor":"overlay"} -->
