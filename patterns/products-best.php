...
<div class="wp-block-button is-style-tyche-link"><a class="wp-block-button__link wp-element-button" href="<?php echo esc_url( tyche_shop_sorted_url( 'popularity' ) ); ?>"><?php esc_html_e( 'Shop best sellers', 'tyche' ); ?></a></div>
<!-- /wp:button --></div>
<!-- /wp:buttons --></div>
<!-- /wp:group --></div>
<!-- /wp:group -->
...
<div class="wp-block-woocommerce-product-collection alignwide"><!-- wp:group {"className":"tyche-carousel-nav","layout":{"type":"flex","justifyContent":"right","flexWrap":"nowrap"}} -->
<div class="wp-block-group tyche-carousel-nav"><!-- wp:woocommerce/product-gallery-large-image-next-previous {"layout":{"type":"flex","flexWrap":"nowrap"}} -->
