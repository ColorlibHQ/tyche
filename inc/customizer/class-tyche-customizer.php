...
class Tyche_Customizer {
	...
	public function customize_preview_js() {
		wp_enqueue_script( 'tyche_customizer', get_template_directory_uri() . '/inc/customizer/assets/js/previewer.js', array( 'customize-preview' ), wp_get_theme()->get( 'Version' ), true );
		wp_localize_script(
