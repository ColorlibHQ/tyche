jQuery(document).ready(function () {
	var tyche_aboutpage = newspaperXWelcomeScreenCustomizerObject.aboutpage;
	var tyche_nr_actions_required = newspaperXWelcomeScreenCustomizerObject.nr_actions_required;
