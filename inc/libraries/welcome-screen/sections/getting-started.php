...
<div class="feature-section three-col">
	<div class="col">
		...
		<?php } else { ?>
			<p><span class="dashicons dashicons-no-alt"></span> <a
						href="<?php echo admin_url( 'themes.php?page=tyche-welcome&tab=recommended_actions' ); ?>"><?php esc_html_e( 'Check recommended actions', 'tyche' ); ?></a>
			</p> <?php
}; ?>
	</div><!--/.col-->
	...
	<div class="col">
		...
		<p>
			<a target="_blank"
			   href="<?php echo esc_url( 'https://colorlib.com/wp/forums/' ); ?>"><?php esc_html_e( 'Full documentation', 'tyche' ); ?></a>
		</p>
	</div><!--/.col-->
	...
	<div class="col">
		...
		<p><a target="_blank" href="<?php echo esc_url( $customizer_url ); ?>"
			  class="button button-primary"><?php esc_html_e( 'Go to Customizer', 'tyche' ); ?></a>
		</p>
	</div><!--/.col-->
</div><!--/.feature-section-->
